package com.example.watchinventorydurbarmarg.Income.View;
...
import com.example.watchinventorydurbarmarg.Income.Presenter.IncomePresenter;
import com.example.watchinventorydurbarmarg.R;

import java.util.Calendar;

public class IncomeView extends AppCompatActivity implements IncomeContracts.view {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        datePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(IncomeView.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
